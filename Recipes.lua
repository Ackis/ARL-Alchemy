...
function module:InitializeRecipes()
	...
	recipe:AddTrainer(1215, 1246, 1386, 1470, 2132, 2391, 2837, 3009, 3184, 3347, 4900, 5177, 5499, 7948, 16161, 16588, 16642, 16723, 17215, 18802, 26903, 26951, 26975, 26987, 27023, 27029, 33608, 33630, 47384, 47396, 47400, 47418, 47419, 47421, 47431, 48619, 49885, 56777, 57620, 65043, 65186, 85905, 86009, 92456, 92458)
	...
	recipe:SetItemFilterType("ALCHEMY_ELIXIR")
	recipe:AddFilters(F.CASTER, F.HEALER)
	recipe:AddTrainer(1215, 1386, 1470, 2132, 2391, 2837, 3009, 3184, 3347, 4900, 5177, 5499, 7948, 16161, 16588, 16642, 16723, 17215, 18802, 26903, 26951, 26975, 26987, 27023, 27029, 33608, 33630, 49885, 56777, 65186)
	...
	recipe:SetItemFilterType("ALCHEMY_POTION")
	recipe:AddTrainer(1215, 1386, 1470, 2132, 2391, 2837, 3009, 3184, 3347, 4900, 5177, 5499, 7948, 16161, 16588, 16642, 16723, 18802, 26903, 26951, 26975, 26987, 27023, 27029, 33608, 33630, 56777, 65186)
	...
	recipe:AddTrainer(2132, 3009, 3184, 3347, 4900, 5177, 5499, 16588, 16642, 16723, 18802, 26903, 26987, 33608, 33630, 56777, 65186)
	...
	recipe:SetItemFilterType("ALCHEMY_ELIXIR")
	recipe:AddFilters(F.DPS)
	recipe:AddTrainer(1386, 2132, 2391, 3009, 3184, 3347, 4900, 5177, 16588, 16642, 16723, 18802, 19052, 26903, 26951, 26975, 26987, 27023, 27029, 33608, 33630, 33674, 56777, 65186)
	...
	recipe:SetItemFilterType("ALCHEMY_OIL")
	recipe:AddTrainer(1386, 2132, 2391, 3009, 3184, 3347, 4900, 5177, 16588, 16642, 16723, 18802, 26903, 26951, 26975, 26987, 27023, 27029, 28703, 33588, 33608, 33630, 56777, 65186)
	...
	recipe:SetItemFilterType("ALCHEMY_TRANSMUTE")
	recipe:AddTrainer(1386, 2132, 2391, 3009, 3184, 3347, 4900, 5177, 5499, 16588, 16642, 16723, 18802, 26903, 26951, 26975, 26987, 27023, 27029, 33608, 33630, 56777, 65186)
	...
	recipe:SetItemFilterType("ALCHEMY_POTION")
	recipe:AddTrainer(2132, 3009, 3184, 3347, 4900, 5177, 16588, 16642, 18802, 33608, 33630, 65186)
	...
	recipe:SetItemFilterType("ALCHEMY_TRINKET")
	recipe:AddFilters(F.CASTER, F.DPS, F.HEALER)
	recipe:AddTrainer(1386, 2132, 2391, 3009, 3184, 3347, 4900, 5177, 16588, 16642, 16723, 18802, 26903, 26951, 26975, 26987, 27023, 27029, 33608, 33630, 56777, 65186)
	...
	recipe:SetItemFilterType("ALCHEMY_TRANSMUTE")
	recipe:AddTrainer(122703, 132228, 153811)
	...
	-- Potion of Shifting States -- 288176 -- Training
	recipe = AddRecipe(288176, V.BFA, Q.COMMON)
	recipe:SetSkillLevels(0, 0, 0, 0, 0)

	-- Potion of Durability -- 288182 -- Training
	...
	-- Potion of Reconstitution -- 298737
	recipe = AddRecipe(298737, V.BFA, Q.COMMON)
	recipe:SetSkillLevels(125, 125, 135, 140, 145)
	recipe:SetCraftedItem(168502, "BIND_ON_EQUIP")
	recipe:SetItemFilterType("ALCHEMY_POTION")
	recipe:AddTrainer(153811)

	-- Potion of Reconstitution -- 298738
	recipe = AddRecipe(298738, V.BFA, Q.COMMON)
	recipe:SetSkillLevels(140, 140, 150, 155, 160)
	recipe:SetCraftedItem(168502, "BIND_ON_EQUIP")
	recipe:SetItemFilterType("ALCHEMY_POTION")
	recipe:AddTrainer(153811)

	-- Potion of Reconstitution -- 298740
	recipe = AddRecipe(298740, V.BFA, Q.EPIC)
	recipe:SetSkillLevels(155, 155, 175, 175, 175)
